...
- Write the command "javac GET.java PUT.java DELETE.java Response.java CLOSE.java Server.java Client.java" (Note the ordering should be same as described because server and client classes depends on PUT, GET and DELETE files)
...
- Now open a second terminal in the same folder and write the command " java -cp . Client <host Address> <PORT> "
- Replace host address and PORT with server's address and port.
